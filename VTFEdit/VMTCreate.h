...
namespace VTFEdit
{
	ref class CVMTCreate : public System::Windows::Forms::Form
	{
	public:
		CVMTCreate(void)
		{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			System::Resources::ResourceManager^ resources = gcnew System::Resources::ResourceManager(CVMTCreate::typeid);
