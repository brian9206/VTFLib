...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->mnuReset = (gcnew System::Windows::Forms::ContextMenuStrip());
			...
			// grpMiscellaneous
			//
			this->grpMiscellaneous->ContextMenuStrip = this->mnuReset;
			...
			// mnuReset
			//
			this->mnuReset->Items->Add( this->btnReset );
			//
			// btnReset
			//
			...
			__mcTemp__3[2] = "Red Channel";
			__mcTemp__3[3] = "Green  Channel";
			__mcTemp__3[4] = "Blue  Channel";
			...
			array<System::Object^>^ __mcTemp__7 = gcnew array<System::Object^>(3);
			__mcTemp__7[0] = "Box";
			__mcTemp__7[1] = "Triangle";
			__mcTemp__7[2] = "Kaiser";
			...
			// grpGeneral
			//
			this->grpGeneral->ContextMenuStrip = this->mnuReset;
			...
			// grpMipmaps
			//
			this->grpMipmaps->ContextMenuStrip = this->mnuReset;
			...
			// grpNormalMap
			//
			this->grpNormalMap->ContextMenuStrip = this->mnuReset;
			...
			// grpGammaCorrection
			//
			this->grpGammaCorrection->ContextMenuStrip = this->mnuReset;
			...
			// grpResize
			//
			this->grpResize->ContextMenuStrip = this->mnuReset;
			...
			array<System::Object^>^ __mcTemp__16 = gcnew array<System::Object^>(5);
			__mcTemp__16[0] = "Point";
			__mcTemp__16[1] = "Box";
			__mcTemp__16[2] = "Triangle";
			__mcTemp__16[3] = "Kaiser";
			__mcTemp__16[4] = "Mitchell";
			...
			// grpVersion
			//
			this->grpVersion->ContextMenuStrip = this->mnuReset;
			...
			// grpLuminanceWeights
			//
			this->grpLuminanceWeights->ContextMenuStrip = this->mnuReset;
			...
			//
			this->grpUnsharpenMaskOptions->ContextMenuStrip = this->mnuReset;
			...
			// grpDXTCompression
			//
			this->grpDXTCompression->ContextMenuStrip = this->mnuReset;
			...
			// grpXSharpenOptions
			//
			this->grpXSharpenOptions->ContextMenuStrip = this->mnuReset;
			...
			//
			this->grpInformationResource->ContextMenuStrip = this->mnuReset;
			...
			//
			this->grpLODControlResource->ContextMenuStrip = this->mnuReset;
		...
		{
			VTFImageFormat get() { return (VTFImageFormat)this->cboFormat->SelectedIndex; }
		...
		property VTFImageFormat AlphaFormat
		{
			VTFImageFormat get() { return (VTFImageFormat)this->cboAlphaFormat->SelectedIndex; }
			void set( VTFImageFormat ImageFormat )
			{
				int iIndex = Convert::ToInt32( ImageFormat );
		...
		{
			int get() { return this->cboTextureType->SelectedIndex; }
		...
		property vlBool ResizeImage
		{
			vlBool get() { return this->chkResize->Checked == true; }
			void set(vlBool bResize) { this->chkResize->Checked = bResize > 0; }
		}

		property VTFResizeMethod ResizeMethod
		{
			VTFResizeMethod get() { return (VTFResizeMethod)this->cboResizeMethod->SelectedIndex; }
		...
		property VTFResizeFilter ResizeFilter
		{
			VTFResizeFilter get() { return (VTFResizeFilter)this->cboResizeFilter->SelectedIndex; }
			void set( VTFResizeFilter ResizeMethod )
			{
				int iIndex = Convert::ToInt32( ResizeMethod );
		...
		property vlBool ResizeClamp
		{
			vlBool get() { return this->chkResizeClamp->Checked == true; }
			void set(vlBool bResize) { this->chkResizeClamp->Checked = bResize > 0; }
		}

		property vlUInt ResizeClampWidth
		{
			vlUInt get() { return Convert::ToUInt32( this->cboMaximumWidth->Text ); }
		...
		property vlUInt ResizeClampHeight
		{
			vlUInt get() { return Convert::ToUInt32( this->cboMaximumHeight->Text ); }
		...
		property vlBool GenerateMipmaps
		{
			vlBool get() { return this->chkMipmaps->Checked == true; }
			void set(vlBool bGenerateMipmaps) { this->chkMipmaps->Checked = bGenerateMipmaps > 0; }
		}

		property VTFMipmapFilter MipmapFilter
		{
			VTFMipmapFilter get() { return (VTFMipmapFilter)this->cboMipmapFilter->SelectedIndex; }
		...
		property vlBool ConvertToNormalMap
		{
			vlBool get() { return this->chkNormalMap->Enabled && this->chkNormalMap->Checked == true; }
			void set(vlBool bConvertToNormalMap) { this->chkNormalMap->Checked = bConvertToNormalMap > 0; }
		}

		property VTFHeightConversionMethod HeightConversionMethod
		{
			VTFHeightConversionMethod get() { return (VTFHeightConversionMethod)this->cboHeightSource->SelectedIndex; }
		...
		property VTFNormalAlphaResult AlphaResult
		{
			VTFNormalAlphaResult get() { return (VTFNormalAlphaResult)this->cboAlphaResult->SelectedIndex; }
		...
		property vlBool NormalWrap
		{
			vlBool get() { return this->chkNormalWrap->Checked == true; }
			void set(vlBool bResize) { this->chkNormalWrap->Checked = bResize > 0; }
		}
		...
		{
			String^ get() { return this->cboVersion->Text; }
		...
		property vlBool ComputeReflectivity
		{
			vlBool get() { return this->chkReflectivity->Checked == true; }
			void set(vlBool bComputeReflectivity) { this->chkReflectivity->Checked = bComputeReflectivity > 0; }
		}

		property vlBool GenerateThumbnail
		{
			vlBool get() { return this->chkThumbnail->Checked == true; }
			void set(vlBool bGenerateThumbnail) { this->chkThumbnail->Checked = bGenerateThumbnail > 0; }
		}

		property vlBool GenerateSphereMap
		{
			vlBool get() { return this->chkSphereMap->Enabled && this->chkSphereMap->Checked == true; }
			void set(vlBool bGenerateSphereMap) { this->chkSphereMap->Checked = bGenerateSphereMap > 0; }
		}
		...
		property VTFDXTQuality DXTQuality
		{
			VTFDXTQuality get() { return (VTFDXTQuality)this->cboDXTQuality->SelectedIndex; }
		...
		property vlBool CorrectGamma
		{
			vlBool get() { return this->chkGammaCorrection->Checked == true; }
			void set(vlBool bGammaCorrection) { this->chkGammaCorrection->Checked = bGammaCorrection > 0; }
		}

		property vlSingle GammaCorrection
		{
			vlSingle get() { return Convert::ToSingle(this->numGammaCorrection->Value); }
			void set(vlSingle sGammaCorrection) { this->SetNumericUpDownValue(this->numGammaCorrection, Convert::ToDecimal(sGammaCorrection)); }
		}
		...
		property vlSingle LuminanceWeightR
		{
			vlSingle get() { return Convert::ToSingle(this->numLuminanceWeightsR->Value); }
			void set(vlSingle sLuminanceWeightR) { this->SetNumericUpDownValue(this->numLuminanceWeightsR, Convert::ToDecimal(sLuminanceWeightR)); }
		}

		property vlSingle LuminanceWeightG
		{
			vlSingle get() { return Convert::ToSingle(this->numLuminanceWeightsG->Value); }
			void set(vlSingle sLuminanceWeightG) { this->SetNumericUpDownValue(this->numLuminanceWeightsG, Convert::ToDecimal(sLuminanceWeightG)); }
		}

		property vlSingle LuminanceWeightB
		{
			vlSingle get() { return Convert::ToSingle(this->numLuminanceWeightsB->Value); }
			void set(vlSingle sLuminanceWeightB) { this->SetNumericUpDownValue(this->numLuminanceWeightsB, Convert::ToDecimal(sLuminanceWeightB)); }
		}
		...
		property vlSingle UnsharpenMaskRadius
		{
			vlSingle get() { return Convert::ToSingle(this->numUnsharpenMaskRadius->Value); }
			void set(vlSingle sUnsharpenMaskRadius) { this->SetNumericUpDownValue(this->numUnsharpenMaskRadius, Convert::ToDecimal(sUnsharpenMaskRadius)); }
		}

		property vlSingle UnsharpenMaskAmount
		{
			vlSingle get() { return Convert::ToSingle(this->numUnsharpenMaskAmount->Value); }
			void set(vlSingle sUnsharpenMaskAmount) { this->SetNumericUpDownValue(this->numUnsharpenMaskAmount, Convert::ToDecimal(sUnsharpenMaskAmount)); }
		}

		property vlSingle UnsharpenMaskThreshold
		{
			vlSingle get() { return Convert::ToSingle(this->numUnsharpenMaskThreshold->Value); }
			void set(vlSingle sUnsharpenMaskThreshold) { this->SetNumericUpDownValue(this->numUnsharpenMaskThreshold, Convert::ToDecimal(sUnsharpenMaskThreshold)); }
		}
		...
		property vlSingle XSharpenStrength
		{
			vlSingle get() { return Convert::ToSingle(this->numXSharpenStrength->Value); }
			void set(vlSingle sXSharpenStrength) { this->SetNumericUpDownValue(this->numXSharpenStrength, Convert::ToDecimal(sXSharpenStrength)); }
		}

		property vlSingle XSharpenThreshold
		{
			vlSingle get() { return Convert::ToSingle(this->numXSharpenThreshold->Value); }
			void set(vlSingle sXSharpenThreshold) { this->SetNumericUpDownValue(this->numXSharpenThreshold, Convert::ToDecimal(sXSharpenThreshold)); }
		}

		// LOD Control Resource

		property vlBool CreateLODControlResource
		{
			vlBool get() { return this->chkCreateLODControlResource->Checked == true; }
			void set(vlBool bCreateLODControlResource) { this->chkCreateLODControlResource->Checked = bCreateLODControlResource > 0; }
		}

		property vlUInt LODControlClampU
		{
			vlUInt get() { return Convert::ToUInt32(this->numLODControlClampU->Value); }
			void set(vlUInt uiLODControlClampU) { this->SetNumericUpDownValue(this->numLODControlClampU, Convert::ToDecimal(uiLODControlClampU)); }
		}

		property vlUInt LODControlClampV
		{
			vlUInt get() { return Convert::ToUInt32(this->numLODControlClampV->Value); }
			void set(vlUInt uiLODControlClampV) { this->SetNumericUpDownValue(this->numLODControlClampV, Convert::ToDecimal(uiLODControlClampV)); }
		}
...
// LOD Control Resource
		...
		{
			vlBool get() { return this->chkCreateInformationResource->Checked == true; }
			void set(vlBool bCreateInformationResource) { this->chkCreateInformationResource->Checked = bCreateInformationResource > 0; }
		}

		property String^ InformationAuthor
		{
			String^ get() { return this->txtInformationAuthor->Text; }
			void set(String^ sInformationAuthor) { this->txtInformationAuthor->Text = sInformationAuthor; }
		}

		property String^ InformationContact
		{
			String^ get() { return this->txtInformationContact->Text; }
			void set(String^ sInformationContact) { this->txtInformationContact->Text = sInformationContact; }
		}

		property String^ InformationVersion
		{
			String^ get() { return this->txtInformationVersion->Text; }
			void set(String^ sInformationVersion) { this->txtInformationVersion->Text = sInformationVersion; }
		}

		property String^ InformationModification
		{
			String^ get() { return this->txtInformationModification->Text; }
			void set(String^ sInformationModification) { this->txtInformationModification->Text = sInformationModification; }
		}

		property String^ InformationDescription
		{
			String^ get() { return this->txtInformationDescription->Text; }
			void set(String^ sInformationDescription) { this->txtInformationDescription->Text = sInformationDescription; }
		}

		property String^ InformationComments
		{
			String^ get() { return this->txtInformationComments->Text; }
			void set(String^ sInformationComments) { this->txtInformationComments->Text = sInformationComments; }
		}
		...
		private: System::Void btnReset_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			this->numGammaCorrection->Value = (Decimal)2.2f;

			this->numLuminanceWeightsR->Value = (Decimal)0.299f;
			this->numLuminanceWeightsG->Value = (Decimal)0.587f;
			this->numLuminanceWeightsB->Value = (Decimal)0.114f;

			this->numUnsharpenMaskRadius->Value = (Decimal)2.0f;
			this->numUnsharpenMaskAmount->Value = (Decimal)0.5f;
			this->numUnsharpenMaskThreshold->Value = (Decimal)0.0f;

			this->numXSharpenStrength->Value = (Decimal)255.0f;
			this->numXSharpenThreshold->Value = (Decimal)255.0f;
